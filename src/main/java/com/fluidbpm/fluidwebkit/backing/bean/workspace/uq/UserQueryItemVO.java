...
@Getter
@Setter
public class UserQueryItemVO extends ABaseWebVO {
	...
	public UserQueryItemVO(FluidItem fluidItm) {
		super(fluidItm);
	...
	public UserQueryItemVO cloneVO(
			FluidItem fluidItem,
			List<Field> fieldsViewable,
			List<Field> fieldsEditable,
			List<User> allUsers
	) {
		UserQueryItemVO returnVal = new UserQueryItemVO(fluidItem);
