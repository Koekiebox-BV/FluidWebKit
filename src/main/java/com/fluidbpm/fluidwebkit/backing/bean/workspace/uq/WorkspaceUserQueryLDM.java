...
public class WorkspaceUserQueryLDM extends ABaseLDM<WorkspaceFluidItem> {
    ...
    public List<WorkspaceFluidItem> load(
        ...
        if (webKitUserQuery != null) executeCustomProgramLabels = webKitUserQuery.isEnableCalculatedLabels();
        ...
        try {
            ...
            FluidItemListing listing = userQueryClient.executeUserQueryReturnListing(
                    userQueryToExec,
                    false,
            ...
            List<FluidItem> result = listing.getListing();
            long end = System.currentTimeMillis();

            List<WorkspaceFluidItem> wfiList = new ArrayList<>();
            if (listing.getListingCount() != null) this.setRowCount(listing.getListingCount());
            else this.setRowCount(result.size());
